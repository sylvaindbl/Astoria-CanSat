...
img_path_background = r'media/humiditydropcontour.png'
background_shape = add_image_with_positions(img_path_background, {}, zorder=2)

# Chargement de l'image du jauge
img_path_foreground = r'media/humiditydropjauge.png'
...
graduations_positions = {'0%': (1250, 850), '100%': (1250, 240)}
...
rectangle_x_position = 760  # Position x du rectangle
...
rectangle = Rectangle((rectangle_x_position, rectangle_y_position), 400, rectangle_height, color='black', alpha=1, zorder=1)
plt.gca().add_patch(rectangle)

# Affichage de la valeur aléatoire à une position fixe
random_text = plt.text(850, 630, f'{random_value}%', fontsize=20, ha='left', va='top', color='white')
